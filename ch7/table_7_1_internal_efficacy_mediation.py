"""
================================================================
SCRIPT: table_7_1_internal_efficacy_mediation.py
================================================================
PURPOSE:
    Test H2: estimate whether internal political efficacy mediates the
    relationship between technological advancement and political engagement.

OUTPUT:
    Thesis Table 7.1, Single-Mediator Model (Internal Efficacy).
...
res = pg.mediation_analysis(data=df, x="tech_total", m="internal_eff",
