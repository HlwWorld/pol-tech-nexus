"""
================================================================
SCRIPT: figure_5_4_external_eff_dist.py
================================================================
PURPOSE:
    Histogram of the External Political Efficacy composite (mean
    of the eight D2.1 items, after reverse coding of items 1-4).

OUTPUT:
    Thesis Figure 5.4, Distribution of External Efficacy Score
    Saved as: figure_5_4_external_eff_dist.png
...
METHOD:
    ...
    Ocean Depths palette (Soft Sky Blue #5B8FB9).
...
ax.hist(series, bins=20, color=SOFT, edgecolor="white", alpha=0.92)
...
plt.tight_layout()
plt.savefig("figure_5_4_external_eff_dist.png", dpi=200, bbox_inches="tight", facecolor="white")
print("Saved figure_5_4_external_eff_dist.png")
