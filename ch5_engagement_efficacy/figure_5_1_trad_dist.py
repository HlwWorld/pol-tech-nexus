"""
================================================================
SCRIPT: figure_5_1_trad_dist.py
================================================================
PURPOSE:
    Histogram of the Traditional Political Participation composite
    (mean of the twelve C1.1 items on the 1 to 5 Likert metric).

OUTPUT:
    Thesis Figure 5.1, Distribution of Traditional Participation Score
    Saved as: figure_5_1_trad_dist.png
...
METHOD:
    ...
    Ocean Depths palette (Deep Ocean #0B3D5B). Times New Roman.
...
plt.tight_layout()
plt.savefig("figure_5_1_trad_dist.png", dpi=200, bbox_inches="tight", facecolor="white")
print("Saved figure_5_1_trad_dist.png")
